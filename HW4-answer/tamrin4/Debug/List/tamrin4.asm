...
; 0000 000E DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 000F // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
...
; 0000 0019 // Function: Bit7=In Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 001A DDRC=(0<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(127)
	OUT  0x14,R30
; 0000 001B // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 0026       PORTC=0;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 0027       if(PINA.0==0){
	SBIC 0x19,0
	RJMP _0x7
; 0000 0028       while(PINA.0==0){}
_0x8:
	SBIS 0x19,0
	RJMP _0x8
; 0000 0029       for(i=0;i<5;i++){
	CLR  R4
	CLR  R5
_0xC:
	LDI  R30,LOW(5)
	...
	CPC  R5,R31
	BRGE _0xD
; 0000 002A       PORTC=sevnum[i];
	LDI  R26,LOW(_sevnum)
	LDI  R27,HIGH(_sevnum)
	ADD  R26,R4
	ADC  R27,R5
	LD   R30,X
	OUT  0x15,R30
