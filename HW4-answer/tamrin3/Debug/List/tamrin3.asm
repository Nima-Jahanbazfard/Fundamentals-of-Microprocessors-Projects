...
; 0000 0015 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0016 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 0017 PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(1)
	OUT  0x18,R30
; 0000 0018 
; 0000 0019 // Port C initialization
; 0000 001A // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 001B DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 001C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 0027 PORTC=0;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 0028  if(PINB.0==0){
	SBIC 0x16,0
	RJMP _0x7
; 0000 0029  while(PINB.0==0){}
_0x8:
	SBIS 0x16,0
	RJMP _0x8
; 0000 002A  for(i=0;i<=9;i++){
	CLR  R4
	CLR  R5
_0xC:
	LDI  R30,LOW(9)
