...
_0x3:
	.DB  0x77,0x7C,0x39,0x5E,0x79,0x71,0x6F,0x76
_0x4:
...
; 0000 0011 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0012 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 0013 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 0014 
...
; 0000 0022 // Function: Bit7=In Bit6=Out Bit5=Out Bit4=Out Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0023 DDRD=(0<<DDD7) | (1<<DDD6) | (1<<DDD5) | (1<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(127)
	OUT  0x11,R30
; 0000 0024 // State: Bit7=T Bit6=0 Bit5=0 Bit4=0 Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 002A       PORTD=0;
	OUT  0x12,R30
; 0000 002B       if(PINA.0==0){
	SBIC 0x19,0
	RJMP _0x8
; 0000 002C       while(PINA.0==0){}
_0x9:
	SBIS 0x19,0
	RJMP _0x9
