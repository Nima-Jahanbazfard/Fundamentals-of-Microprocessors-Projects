...
; 0000 0012 DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (0<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	OUT  0x17,R30
; 0000 0013 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 0014 PORTB=(0<<PORTB7) | (0<<PORTB6) | (0<<PORTB5) | (0<<PORTB4) | (0<<PORTB3) | (0<<PORTB2) | (0<<PORTB1) | (1<<PORTB0);
	LDI  R30,LOW(1)
	OUT  0x18,R30
; 0000 0015 
; 0000 0016 // Port C initialization
; 0000 0017 // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=Out Bit1=Out Bit0=Out
; 0000 0018 DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 0019 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
_0x3:
; 0000 0023       {
; 0000 0024       PORTC=PINC-1;
	RCALL SUBOPT_0x0
; 0000 0025       delay_ms(300);
; 0000 0026       if(PINB.0==0){
	SBIC 0x16,0
	RJMP _0x6
; 0000 0027       PORTC=10;
	LDI  R30,LOW(10)
	OUT  0x15,R30
; 0000 0028       while(PINB.0==0){}
_0x7:
	SBIS 0x16,0
	RJMP _0x7
; 0000 0029       PORTC=PINC-1;
	RCALL SUBOPT_0x0
